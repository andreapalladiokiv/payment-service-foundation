...
/**
 * Bulk-import event for an existing refund recorded against the parent
 * PaymentIntent. The refund's terminal status is inferred from the source
 * data (gateway export, settlement file, ...) — the parent boots a Refund
 * child in this state on apply.
 */
final readonly class RefundImported implements SerializablePayload
{
    ...
    public static function fromPayload(array $payload): static
    {
        return new self(
            ...
            RefundStatus::from($payload['status']),
