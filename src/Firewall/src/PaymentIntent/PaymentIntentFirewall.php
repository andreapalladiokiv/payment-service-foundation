 ...
 *
 * Policy-free, as the port requires: a chain that matches nothing returns
 * {@see FirewallDecision::noMatch()}, and what that is worth is the caller's
 * business (see {@see FirewallDecision::permits()} for the domain's answer).
 *
